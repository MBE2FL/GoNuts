...
FreeType::FreeType(string ttfName)
{
	if (FT_Init_FreeType(&ft))
		cout << "Error::Freetype: freetype library did not init" << endl;

	string filePath = "./Assets/Fonts/" + ttfName;

	if (FT_New_Face(ft, filePath.c_str(), 0, &face))
		cout << "Error::freetype: font did not load :(" << endl;
}

void FreeType::Init(int width, int height)
{

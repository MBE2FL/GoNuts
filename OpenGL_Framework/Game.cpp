...
void Game::initializeGame()
{
	...
	ObjectLoader::loadSkeletalMesh("SkeletalBeast", "./Assets/Test Exporter/GOOD/BEAST_RUN/Armature.nut", "./Assets/Test Exporter/GOOD/BEAST_RUN/Anims/Action.nutAnim");
	ObjectLoader::loadSkeletalMesh("SkeletalBird", "./Assets/Test Exporter/GOOD/BIRD_FLIGHT/Armature.nut", "./Assets/Test Exporter/GOOD/BIRD_FLIGHT/Anims/Action.nutAnim");
	//ObjectLoader::loadSkeletalMesh("SkeletalBeast", "./Assets/Test Exporter/GOOD/CHEEKS_RUN/Armature.nut", "./Assets/Test Exporter/GOOD/CHEEKS_RUN/Anims/Action.nutAnim");
